...
donationNoakhali.addEventListener('click', function (e) {
    ...
    <div class="card card-compact bg-green-400 shadow-xl w-full mb-5">
        <div class="card-body">
          <h2 class="card-title">${donationAmount} Taka ${getElemById('donate-name-noakhali').innerHTML}</h2>
          <p>${new Date()}</p>
        </div>
    </div>
    `
...
donationFeni.addEventListener('click', function (e) {
    ...
    <div class="card card-compact bg-green-400 shadow-xl w-full mb-5">
        <div class="card-body">
          <h2 class="card-title">${donationAmount} Taka ${getElemById('donate-name-feni').innerHTML}</h2>
          <p>${new Date()}</p>
        </div>
    </div>
    `
...
donationQuota.addEventListener('click', function (e) {
    ...
    <div class="card card-compact bg-green-400 shadow-xl w-full mb-5">
        <div class="card-body">
          <h2 class="card-title">${donationAmount} Taka ${getElemById('donate-name-quota').innerHTML}</h2>
          <p>${new Date()}</p>
        </div>
    </div>
    `
